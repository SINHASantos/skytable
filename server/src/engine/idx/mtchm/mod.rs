...
/*
    ...
    simplifies some of the features as described in the original paper, with some inspirations[3] but has several other custom
    changes for maintenance, performance and custom features tuned to the use-case for Skytable.

    ## High memory overhead (explanation)
